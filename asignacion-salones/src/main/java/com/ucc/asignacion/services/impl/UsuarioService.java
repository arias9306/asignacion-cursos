...
public class UsuarioService implements IUsuarioService {
	...
	@Override
	public void actualizarPassword(UsuarioModel usuario, ContrasenaModel contrasena) {

		Optional<Usuario> baseUsuario = usuarioRepository.findById(usuario.getIdUser());
		if (baseUsuario.isPresent()) {
			baseUsuario.get().setPassword(contrasena.getNuevaPassword());
			usuarioRepository.save(baseUsuario.get());
		}
	}
